  ...
  <header>
        <nav>
            <div class="nav">
                ...
                <a href="view/main.jsp"> <h1>CHUNG! NAM! OH! SHU!</h1> </a>

                <div class="nav-items">
                    <div class="nav-item">
                        <a href="view/signin.jsp">SIGN_IN</a>
                    </div>
                    <div class="nav-item">
                        <a href="view/signup.jsp">SIGN_UP</a>
                    </div>
                    <div class="nav-item">
                        MY_PAGE
                    </div>
    ...
    <div class="container">
        ...
        <div class="lis">
            <ul class="lis">
                <li class="lis">
                    <a href="view/page1.jsp">개요</a></li>
                <li class="lis">
                    <a href="view/page2.jsp">음식</a></li>
                <li class="lis">
                    <a href="view/page3.jsp">여행</a></li>
                <li class="lis">
                    <a href="view/page4.jsp">숙박</a></li>
            </ul>
        </div>
