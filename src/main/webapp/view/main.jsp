...
<body>
	...
	<div class="container">
		...
		<div class="img-boxs">
			...
			<img class="img-fluid" src="https://via.placeholder.com/350x300"
				alt=""> <img class="img-fluid"
				src="https://via.placeholder.com/350x300" alt=""> <img
				class="img-fluid" src="https://via.placeholder.com/350x300" alt="">
		</div>
		<br> <br>
		<div class="row-main">
			<div class="col-md-8">
