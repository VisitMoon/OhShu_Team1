...
<body>
   ...
   <header>
      <nav>
         <div class="nav">
               <a style="color:black;" href="main.jsp"> <h1>CHUNG! NAM! OH! SHU!</h1></a>
            <div class="nav-items">
               <c:choose>
                  <c:when
                  ...
                  <c:otherwise>
                     <a style="color:black;" href="<%=request.getContextPath()%>/SignIn">로그인</a>
                     <div class="nav-item">
                     <a style="color:black;" href="http://localhost:8080/OhShu_Team1/join">회원가입</a>
                     </div>
   ...
   <div class="container">
      ...
      <div class="lis">
         <ul class="lis">
            <li class="lis"><a style="color:black;" href="introduction.jsp">개요</a></li>
            <li class="lis"><a style="color:black;" href="stay_allCategory_page.jsp">숙박</a></li>
            <li class="lis"><a style="color:black;" href="tour_allCategory_page.jsp">여행</a></li>
            <li class="lis"><a style="color:black;" href="food_allCategory_page.jsp">음식</a></li>
         </ul>
      </div>
      ...
      <div class="row">
         <div class="col-md-8">
            <img src="<%=request.getContextPath()%>/img/resoure/루피.gif" style="width: 5%">
            <img class="img-fluid-main" src="<%=request.getContextPath()%>/img/resoure/chungman_slogan.jpg" style="width: 30%">
            <img src="<%=request.getContextPath()%>/img/resoure/루피.gif" style="width: 5%">
         </div>
         <div class="col-md-4">
            <h3 class="my-3">안녕하세요, 충남오슈입니다. 즐거운 여행되세요.</h3>
            <p>충청남도의 매력을 왕창 즐길 수 있는 정보 가득한 충남오슈가 되겠습니다.</p>
            <br>
         </div>
      </div>
   </div>
   ...
   <div style="text-align: center;" class="img-boxs">
      <div>
         ...
         <a href="food_detail_page.jsp?foodNo=<%=food_index%>">
         <img style="text-align: center;" class="img-fluid" src="<%=food_vo.getFood_img()%>"> </a>
         <br>
         <p style="font-size: 15pt; color: blue; font-weight: bold;">
         <span style="color:red;">♥</span> <%= food_vo.getJoayo_amount() %> Like </p>
      </div>
      
      <div>
         <h3 style="text-align: center;">여행1위</h3>
         <a href="tour_detail_page.jsp?tourNo=<%=tour_index%>">
         <img style="text-align: center;" class="img-fluid" src="<%=tour_vo.getTour_img()%>"> </a>
         <br>
         <p style="font-size: 15pt; color: blue; font-weight: bold;">
         <span style="color:red;">♥</span> <%= tour_vo.getJoayo_amount() %> Like </p>
      </div>
      
      <div>
         <h3 style="text-align: center;">숙박1위</h3>
         <a href="stay_detail_page.jsp?stayNo=<%=stay_index%>"> 
         <img style="text-align: center;" class="img-fluid" src="<%=stay_vo.getStay_img()%>"> </a>
         <br>
         <p style="font-size: 15pt; color: blue; font-weight: bold;">
         <span style="color:red;">♥</span> <%= stay_vo.getJoayo_amount() %> Like </p>
      </div>
   </div>
   <br>
   <div style="text-align: center;">
      <div class="col-md-8">
         <img class="img-fluid-main" src="<%=request.getContextPath()%>/img/resoure/mascot.JPG" style="width: 15%">
      </div>
   </div>
   <br>
   <br>
