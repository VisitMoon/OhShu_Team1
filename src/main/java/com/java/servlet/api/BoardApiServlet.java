...
import com.java.servlet.service.impl.BoardApiServicempl;
...
public class BoardApiServlet extends HttpServlet {
	...
	private final BoardApiService service = BoardApiServicempl.getInstance(); 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		vo.setB_no( Integer.parseInt(request.getParameter("b_no")));
